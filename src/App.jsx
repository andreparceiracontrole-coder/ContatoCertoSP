  ...
  return <div className="space-y-3">
    ...
    {mode==="montador" && <>
      <div className="bg-yellow-50 border-2 border-yellow-400 p-3 rounded-2xl">
        ...
        <div className="text-[10px] text-gray-600 mt-1">Sua foto aparece para cliente quando aceita pedido - Compactada automaticamente (300x300, ~30KB)</div>
        <div className="mt-3 flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="text-[10px] text-gray-500 mt-1">📱 Galeria do celular - JPG/PNG até 5MB - Compactada para 300x300 (SEM CAMERA)</div>
